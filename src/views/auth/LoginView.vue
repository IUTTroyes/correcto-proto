...
<template>
  <div class="h-screen flex flex-col items-center justify-center max-w-lg mx-auto">
    <div class="w-full mx-auto mt-10 p-5 border border-gray-200 rounded-lg shadow-md">
    ...
    <div class="w-full mx-auto mt-10 p-5 border border-blue-200 rounded-lg bg-blue-50">
